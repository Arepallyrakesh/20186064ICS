 ...
 */
int negate(int x) {
	/* Takes advantage of how the negative version of a number
         * in 2's complement is the 1's complement + 1.*/
        int f;
        f = ~x;
        f = f+1;
        return f;
...
int divpwr2(int x, int n) {
   //All that needs to be done here is an arithmetic right shift by n bits. However,
  //1 needs to be added to x after it is shifted in certain situations.
